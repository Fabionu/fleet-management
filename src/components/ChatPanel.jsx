      ...
      {openCards.map((card, idx) => {
        ...
        return (
          ...
          {actionMenu?.cardKey === card.key && (
            <div data-chat-action-menu style={{ position: 'absolute', top: actionMenu.relY, right: 4, background: 'var(--surface)', border: '1px solid var(--gray-2)', borderRadius: 10, boxShadow: '0 4px 24px rgba(0,0,0,0.18)', padding: 4, zIndex: 100, minWidth: 152 }}>
              {[
